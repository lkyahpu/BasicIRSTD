...
class USwinT(nn.Module):
    def __init__(self, config, n_channels=1, n_classes=1, img_size=256, vis=False):###224
        super().__init__()
        self.vis = vis
        ...
        self.sw = SwinTransformer(in_chans=1,
                            patch_size=4,
                            window_size=12,
                            embed_dim=128,
                            depths=(2, 2, 18, 2),
        ...
        self.transform1 = transforms.Compose([transforms.Resize((256, 256))])
