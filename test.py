...
parser.add_argument("--model_names", default=['FTCNet'], type=list,
                    help="model_name: 'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'ISTDU-Net', 'U-Net', 'RISTDnet'")
parser.add_argument("--pth_dirs", default=['log2/PRCVdata/FTCNet_1.pth.tar'], type=list, help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
...
if __name__ == '__main__':
    ...
    if opt.pth_dirs == None:
        for i in range(len(opt.model_names)):
            ...
            opt.f.write(opt.model_name + '_1.pth.tar' + '\n')
            for dataset_name in opt.dataset_names:
                ...
                opt.pth_dir = opt.save_log + opt.dataset_name + '/' + opt.model_name + '_1.pth.tar'
                test()
            print('\n')
            opt.f.write('\n')
        opt.f.close()
